...
import com.github.rosjava.android_remocons.rocon_remocon.linphone.LinphoneService;
...
public class RemoteProvisioningActivity extends Activity {
	...
	private void goToLinphoneActivity() {
		if (LinphoneService.isReady()) {
			LinphoneService.instance().setActivityToLaunchOnIncomingReceived("com.github.rosjava.android_remocons.rocon_remocon.linphone.LinphoneLauncherActivity");
