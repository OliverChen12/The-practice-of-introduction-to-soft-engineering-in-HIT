...
import turtlebot_msgs.TakePanoramaRequest;
import turtlebot_msgs.TakePanoramaResponse;
...
public class PanoramaActivity extends RosAppActivity implements NodeMain
{
  ...
  private final MessageCallable<Bitmap, CompressedImage> callable =
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    setDefaultAppName(getString(R.string.default_app_panorama));
    setDashboardResource(R.id.top_bar);
    setMainWindowResource(R.layout.activity_panorama);
  ...
  protected void callService(byte mode)
  {
    ...
    ServiceClient<TakePanoramaRequest, TakePanoramaResponse> serviceClient;
    try
    {
    ...
    final TakePanoramaRequest request = serviceClient.newMessage();
    ...
    serviceClient.call(request, new ServiceResponseListener<TakePanoramaResponse>() {
      @Override
      public void onSuccess(TakePanoramaResponse response) {
        Log.i("PanoramaActivity", "Service result: success (status " + response.getStatus() + ")");
        if (request.getMode() == TakePanoramaRequest.STOP)
  ...
  public void onStart(ConnectedNode connectedNode)
  {
    ...
    Subscriber<CompressedImage> subscriber =
        connectedNode.newSubscriber(panoImgTopic, CompressedImage._TYPE);
  ...
  private final OnClickListener startButtonListener = new OnClickListener()
  {
    ...
    public void onClick(View v)
    {
      ...
      if (continuous.isChecked() == true)
        callService(TakePanoramaRequest.CONTINUOUS);
      else
        callService(TakePanoramaRequest.SNAPANDROTATE);
    }
  };
  ...
  private final OnClickListener stopButtonListener = new OnClickListener()
  {
    ...
    public void onClick(View v)
    {
      callService(TakePanoramaRequest.STOP);
    }
  };
